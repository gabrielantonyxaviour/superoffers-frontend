...
export default function OfferCard({
  ...
  return (
    <Link to={"/offers/" + offerId}>
      <div className=" pt-5 px-5 pb-1 my-4  rounded-xl text-[#A9A9A9] bg-gradient-to-br from-black to-[#181818] w-full  hover:from-[#4cbb17] hover:-translate-y-1 hover:scale-105 cursor-pointer hover:text-white hover:to-[#235f07] delay-50 transition ease-in-out duration-500">
        <div className="flex">
